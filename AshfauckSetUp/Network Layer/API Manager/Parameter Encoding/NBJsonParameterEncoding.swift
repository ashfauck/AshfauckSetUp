...
public struct NBJSONParameterEncoder: ParameterEncoder
{
...
public struct NBJSONStringParameterEncoder: ParameterEncoder
{
    public func encode(urlRequest: inout URLRequest, with parameters: Parameters) throws
    {
...
public struct NBUploadMultiPartEncoder: ParameterEncoder
{
    public func encode(urlRequest: inout URLRequest, with parameters: Parameters) throws {
